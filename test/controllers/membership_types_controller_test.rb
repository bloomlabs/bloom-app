...
class MembershipTypesControllerTest < ActionController::TestCase
  ...
  #     post :create, membership_type: { autoapprove: @membership_type.autoapprove, name: @membership_type.name, price: @membership_type.price, recurring: @membership_type.recurring }
  #   end
  #
  ...
  #   patch :update, id: @membership_type, membership_type: { autoapprove: @membership_type.autoapprove, name: @membership_type.name, price: @membership_type.price, recurring: @membership_type.recurring }
  #   assert_redirected_to membership_type_path(assigns(:membership_type))
  # end
  #
